...
-> Crie uma função que encontra o primeiro duplicado, considerando o segundo número como a duplicação
    Requisitos:
        A ordem do número duplicado é considerada a partir da segunda ocorrência do número (o número duplicado em si).
...
def encontra_duplicado(param_lista_de_inteiros):
